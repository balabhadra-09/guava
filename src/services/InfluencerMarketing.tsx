...
export function InfluencerMarketing() {
  return (
    <>
      <Helmet>
        <title>Influencer Marketing | Synapse</title>
        <meta name="description" content="Expert Influencer Marketing services by Synapse Digital Agency." />
      </Helmet>
    ...
    <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-violet-500/20 via-indigo-400/20 to-transparent" />
    <div className="container relative z-10 px-6 mx-auto pt-40 pb-20 lg:pt-56 lg:pb-32">
      <div className="max-w-3xl">
        <h1 className="text-6xl lg:text-8xl font-bold mb-8 font-outfit tracking-tighter">Influencer Marketing</h1>
        <p className="text-2xl text-gray-500 mb-10 font-light">Premium Influencer Marketing solutions for forward-thinking brands.</p>
      </div>
    </div>
        ...
        <SectionWrapper>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl font-bold mb-4 text-fuchsia-500">The Challenge</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map(i => (
              <Card key={i} className="p-8">
                <div className="w-12 h-12 rounded-lg bg-fuchsia-500/20 mb-6" />
