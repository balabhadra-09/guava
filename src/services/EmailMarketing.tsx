...
export function EmailMarketing() {
  return (
    <>
      <Helmet>
        <title>Email Marketing | Synapse</title>
        <meta name="description" content="Expert Email Marketing services by Synapse Digital Agency." />
      </Helmet>
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-amber-400/20 via-rose-500/20 to-transparent opacity-20" />
    <div className="container relative z-10 px-6 mx-auto pt-32 pb-20 lg:pt-48 lg:pb-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="order-1 lg:order-2">
        <h1 className="text-5xl lg:text-show font-bold mb-6 font-outfit text-right">Email Marketing</h1>
        <p className="text-xl text-gray-400 mb-10 text-right">Premium Email Marketing solutions for forward-thinking brands.</p>
      </div>
    </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map(i => (
                  <Card key={i} className="p-6 text-center" variant="glass-dark">
                    <div className="w-10 h-10 mx-auto rounded-full border border-cyan-400/50 mb-4 flex items-center justify-center text-cyan-400">✦</div>
