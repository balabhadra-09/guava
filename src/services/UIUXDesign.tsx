...
export function UIUXDesign() {
  return (
    <>
      <Helmet>
        <title>UI/UX Design | Synapse</title>
        <meta name="description" content="Expert UI/UX Design services by Synapse Digital Agency." />
      </Helmet>
    ...
    <div className="absolute inset-0 bg-gradient-to-r from-violet-500/20 via-indigo-400/20 to-transparent opacity-20" />
    <div className="container relative z-10 px-6 mx-auto pt-32 pb-20 lg:pt-48 lg:pb-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div>
        <h1 className="text-5xl lg:text-7xl font-bold mb-6 font-outfit">UI/UX Design</h1>
        <p className="text-xl text-gray-400 mb-10">Premium UI/UX Design solutions for forward-thinking brands.</p>
      </div>
      <div className="relative aspect-square">
        <div className="absolute inset-0 bg-gradient-to-tr from-violet-500/20 via-indigo-400/20 to-transparent rounded-full blur-3xl opacity-40 animate-pulse" />
              ...
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map(i => (
                  <Card key={i} className="p-6 text-center" variant="glass-dark">
                    <div className="w-10 h-10 mx-auto rounded-full border border-fuchsia-500/50 mb-4 flex items-center justify-center text-fuchsia-500">✦</div>
