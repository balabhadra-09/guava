...
export function GraphicDesign() {
  return (
    <>
      <Helmet>
        <title>Graphic Design | Synapse</title>
        <meta name="description" content="Expert Graphic Design services by Synapse Digital Agency." />
      </Helmet>
    ...
    <div className="absolute inset-0 bg-gradient-to-br from-emerald-400/20 via-cyan-400/20 to-transparent opacity-30" />
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] bg-emerald/10 rounded-full blur-[120px] pointer-events-none" />
    <div className="container relative z-10 px-6 mx-auto text-center pt-32 pb-20 lg:pt-48 lg:pb-32">
      <h1 className="text-5xl lg:text-7xl font-bold mb-6 font-outfit">Graphic Design</h1>
      <p className="text-xl text-gray-400 max-w-2xl mx-auto mb-10">Premium Graphic Design solutions for forward-thinking brands.</p>
    </div>
        ...
        <SectionWrapper>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl font-bold mb-4 text-neon-pink">The Challenge</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map(i => (
              <Card key={i} className="p-8">
                <div className="w-12 h-12 rounded-lg bg-neon-pink/20 mb-6" />
