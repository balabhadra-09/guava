...
export function AppDevelopment() {
  return (
    <>
      <Helmet>
        <title>App Development | Synapse</title>
        <meta name="description" content="Expert App Development services by Synapse Digital Agency." />
      </Helmet>
    ...
    <div className="absolute inset-0 bg-gradient-to-t from-teal-400/20 via-emerald-500/20 to-transparent opacity-20" />
    <div className="container relative z-10 px-6 mx-auto pt-32 pb-20 lg:pt-48 lg:pb-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="order-1 lg:order-2">
        <h1 className="text-5xl lg:text-show font-bold mb-6 font-outfit text-right">App Development</h1>
        <p className="text-xl text-gray-400 mb-10 text-right">Premium App Development solutions for forward-thinking brands.</p>
      </div>
    </div>
        ...
        <SectionWrapper>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl font-bold mb-4 text-violet-500">The Challenge</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[1, 2, 3].map(i => (
              <Card key={i} className="p-8">
                <div className="w-12 h-12 rounded-lg bg-violet-500/20 mb-6" />
